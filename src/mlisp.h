...
MERROR_RETVAL mlisp_parse_c( struct MLISP_PARSER* parser, char c ) {
   ...
   debug_printf( MLISP_TRACE_LVL,
      SIZE_T_FMT ": %c (%s (%d)) (sz: " SIZE_T_FMT ")",
      parser->base.i, c, gc_mlisp_pstate_names[mlisp_parser_pstate( parser )],
